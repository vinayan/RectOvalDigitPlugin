...
if	s:MSWIN
	...
	call s:C_SetGlobalVariable ( 'C_CCompiler',     'clang' )
	call s:C_SetGlobalVariable ( 'C_CplusCompiler', 'clang++' )
...
let s:C_VimCompilerName				= 'clang'      " the compiler name used by :compiler
"
