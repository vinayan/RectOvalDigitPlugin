...
from advanced_draw_tools_circle import *
from advanced_draw_tools_rect import *
from advanced_draw_tools_ellipse import *
...
class AdvancedDraw:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'AdvancedDraw_{}.qm'.format(locale))
    ...
    def initGui(self):
        ...
        self.toolBar.setObjectName("AdvancedDraw")
        ...
        # Add actions
        self.circleBy2Points = QAction(QIcon(":/plugins/AdvancedDraw/icons/circleBy2Points.png"),  "Circle by 2 points",  self.iface.mainWindow())
        self.circleBy3Points = QAction(QIcon(":/plugins/AdvancedDraw/icons/circleBy3Points.png"),  "Circly by 3 points",  self.iface.mainWindow())
        self.circleByCenterRadius = QAction(QIcon(":/plugins/AdvancedDraw/icons/circleByCenterRadius.png"),  "Circle by center and radius",  self.iface.mainWindow())
        self.circleByCenterPoint = QAction(QIcon(":/plugins/AdvancedDraw/icons/circleByCenterPoint.png"),  "Circle by center and a point",  self.iface.mainWindow())
        ...
        self.rectBy3Points = QAction(QIcon(":/plugins/AdvancedDraw/icons/rectBy3Points.png"), "Rectangle by 3 points", self.iface.mainWindow())
        self.rectByExtent = QAction(QIcon(":/plugins/AdvancedDraw/icons/rectByExtent.png"), "Rectangle by extent", self.iface.mainWindow())
        self.rectFromCenter = QAction(QIcon(":/plugins/AdvancedDraw/icons/rectFromCenter.png"), "Rectangle from center", self.iface.mainWindow())
        self.squareFromCenter = QAction(QIcon(":/plugins/AdvancedDraw/icons/squareFromCenter.png"), "Square from center", self.iface.mainWindow())
        ...
        # Add actions
        self.ellipseByCenter2Points = QAction(QIcon(":/plugins/AdvancedDraw/icons/ellipseByCenter2Points.png"),  "Ellipse by center and 2 points",  self.iface.mainWindow())
        self.ellipseByCenter3Points = QAction(QIcon(":/plugins/AdvancedDraw/icons/ellipseByCenter3Points.png"),  "Ellipse by center and 3 points",  self.iface.mainWindow())
        self.ellipseBy4Points= QAction(QIcon(":/plugins/AdvancedDraw/icons/ellipseBy4Points.png"),  "Ellipse by 4 points",  self.iface.mainWindow())
        self.ellipseByFociPoint = QAction(QIcon(":/plugins/AdvancedDraw/icons/ellipseByFociPoint.png"),  "Ellipse by foci and a point",  self.iface.mainWindow())
